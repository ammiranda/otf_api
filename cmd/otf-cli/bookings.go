...
var bookingsCmd = &cobra.Command{
	Use:   "bookings",
	Short: "Manage your class bookings",
	Long:  `List your upcoming OTF bookings and cancel them.`,
}

var listBookingsCmd = &cobra.Command{
	Use:   "list",
	Short: "List your bookings",
	Long: `Shows your upcoming OTF bookings with status.

Interactive mode lets you select a booking to cancel.
With --json, outputs as JSON.
With --cancel and --booking-id, cancels non-interactively.

Examples:
  otf-cli bookings list                    # interactive view/cancel
  otf-cli bookings list --json             # JSON output
  otf-cli bookings list --cancel --booking-id "<id>" --yes`,
...
var cancelBookingCmd = &cobra.Command{
	...
	Short: "Cancel a booking by ID",
	Long: `Cancel a booking by its ID (shown in 'bookings list').

With --yes, skips the confirmation prompt.

Examples:
  otf-cli bookings cancel <booking-id>       # with confirmation
  otf-cli bookings cancel <booking-id> --yes # skip confirmation`,
